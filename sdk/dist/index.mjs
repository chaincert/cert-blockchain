...
var CERT_EVM_CHAIN_ID = 4283207343;
...
var CertID = class {
  constructor(apiUrl, contractOrSigner, contractAddress) {
    this.apiUrl = apiUrl;
    if (contractOrSigner) {
      if (contractOrSigner instanceof ethers2.Contract) {
        this.contract = contractOrSigner;
      } else {
        const address = contractAddress || CONTRACT_ADDRESSES.CERT_ID;
        this.contract = new ethers2.Contract(address, CERT_ID_ABI, contractOrSigner);
      }
    } else {
      this.contract = null;
    }
