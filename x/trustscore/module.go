...
import (
	...
	"github.com/chaincertify/certd/x/trustscore/keeper"
...
// GenesisState defines the trustscore module's genesis state
type GenesisState struct {
	// Scores could be exported/imported here in future
}
